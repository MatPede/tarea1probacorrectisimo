...
mplt.bar(barras, peliculas_americanas_vs_americanants,width=anchura,
      label="Peliculas")
mplt.bar(np.arange(2) + anchura, series_americanas_vs_americanants,width=0.2,
       label="Series")
mplt.legend(loc='upper right')
mplt.xticks(barras + anchura,("USA", "Resto"))
